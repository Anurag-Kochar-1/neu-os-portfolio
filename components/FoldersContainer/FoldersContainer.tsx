...
const FoldersContainer = () => {
  return (
    <div className='p-2 my-2 col-start-2 col-end-12 xl:col-start-7 xl:col-end-11 2xl:col-start-7 2xl:col-end-10 flex flex-wrap justify-between items-center xl:space-x-5'>
